...
public class SignupBackground extends AsyncTask<String, Integer, String> {
    Context context;
    ...
    protected String doInBackground(String... params) {
        ...
        editor = pref.edit();
                ...
                try {
                    ...
                    String post_data = URLEncoder.encode("email", "UTF-8") + "=" + URLEncoder.encode(email, "UTF-8")+ "&" + URLEncoder.encode("mobile", "UTF-8") + "=" + URLEncoder.encode(mobile, "UTF-8")+ "&" + URLEncoder.encode("pass", "UTF-8") + "=" + URLEncoder.encode(pass, "UTF-8");
